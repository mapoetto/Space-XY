...
public class CmdCommands {
	...
	/*
	 * 
	 * Insieme di comandi per rendere pi� ordinata la comunicazione dei pacchetti
	 *
	 */
	...
	public final static String userBusy = "k13246sfdg"; //comando per indicare che l'utente che abbiamo invitato a giocare � gi� occupato
	...
	public final static String setMeFree = "set me free plz"; //comando per impostare lo stato dell'utente a libero dopo che � successo un errore
	...
	public final static String setMyFlottaOK = "i recieved your positions"; //INVIATO DAL SERVERTHREAD comando per indicare che la propria flotta � stata settata
	public final static String letsPlay = "we r playin"; //Serve per scambiare messaggi quando il game � attivo, indica che il game � al primo turno
	public final static String playing = "that's my move"; //Serve per scambiare messsaggi relativi alle mosse quando il game � iniziato
