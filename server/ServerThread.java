...
public class ServerThread extends Thread {
    ...
    public void run() {
        try {
	            ...
	            do {
	            	try {
	            			...
	            			if(inputMsg.getFirstParam() instanceof Game) {
	            				...
	            				if(inputMsg.getSecondParam().equals(CmdCommands.setMyFlotta)) {
	            					...
	            					if(MainServerXY.checkMove(tmpGame,tmpQuad, me)) {
	            						...
	            						if(countWin < currentGame.getMyFlotta(me).size()) {
	            							...
	            							//questo non deve essere mandato, perch� verr� mandato un YOUWIN
	            							
	            							System.out.println("\n non hai vinto perch� hai colpito "+ countWin + "ma flottaSize �: "+ currentGame.getMyFlotta(me).size() + "\n");
	            					...
	            					avversarioThread.send(new Pacchetto(tmpGame,CmdCommands.playing,tmpRand,true)); //notifica all'avversario che � il suo turno
	            				...
	            				if(me.getStato() == "free") {//questo IF permette di poter interagire con una sola persona alla volta
		            				...
		            				if(inputMsg.getSecondParam() instanceof Utente) {
		            					...
		            					if(PoolThread.getThread(destinatarioUtente.getSESSION()).getMe().getStato() == "free") {//se il destinatario non � gi� occupato (lo stato poteva essere preso anche dal secondo paramentro del pacchetto, ma prenderlo dal pooldithread garantisce una sincronizzazione migliore)
		            					...
		            					resp = new Pacchetto("Il secondo parametro inviato non � un Utente","",null,false);
		            				}
	            				}else {
	            					resp = new Pacchetto("Stai gi� interagendo con qualcuno -> "+ me.getStato(),"",null,false);
	            				}
	            					...
	            					if(inputMsg.getSecondParam() instanceof Utente) {
	            						...
	            						resp = new Pacchetto("FATAL ERROR, non c'� il parametro utente " + inputMsg.getFirstParam(),"",null,false);
	            					}
		            				
		            				
	            				}else {
	            					resp = new Pacchetto("Non so cosa risponderti, oppure Stai gi� interagendo con qualcuno -> "+ me.getStato(),"",null,false);
	            				}
		               ...
		               send(resp);
	            		...
	            		if(socket != null) { //se il socket � stato kickato gi� dal poolthread � inutile chiuderlo di nuovo
		            		socket.close();
	            		...
	            		//System.out.println("Class-> "+e.getClass()+"\n C'� un problema col socket, quindi lo metto offline");
    		...
    		MainServerXY.updateStatePanel(this, "<html><b><font color=\"red\">Offline</font></b></html>");
            //System.out.println("Il socket � diventato null, quindi la condizione nel while per l'ascolto perpetuo ha generato un nullPointerException, ma � tutto sotto controllo-> " + ex.getMessage());
