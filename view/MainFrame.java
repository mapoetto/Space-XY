...
public class MainFrame { //VIEW
	...
	public int getDimensionRatio(int Dimension) {
		...
		int valoreDiRiferimento = 1000; //il layout � stato costruito su una base quadrata di 1000 x 1000
	 ...
	 * 
	 * MainFrame � la classe padre (nonch� il VIEW di MVC)
	...
	private void initialize() {
	   		        ...
	   		        public void actionPerformed(ActionEvent e) {
	   		            ...
	   		            if(secondi == 0) {
	   		            	...
	   		            	if(griglia.getNaviInserite().size() != griglia.getNaviDaInserire().size()) {
	   		            		try {
									clientThread.send(new Pacchetto (CmdCommands.iLostTheGame,"Hai perso perch� non hai posizionato le navi in tempo",null,true));
	   		            		...
	   		            		updateLog(new LogMessage("Game","Hai perso la partita, poich� non hai posizionato tutte le navi in tempo!!",dtf.format(LocalTime.now())));
	   		            	}else {
	   		            		
	   		            		updateLog(new LogMessage("Game","Risultano " + griglia.getNaviInserite().size() + " navi inserite, dunque la partita pu� iniziare",dtf.format(LocalTime.now())));
    	...
    	*/
    	 ...
    	 */
    	 ...
    	 lblGimmeUsr.setText("<html><center><font size=\""+getDimensionRatio(9)+"\" style=\" color: white; font-family: " + font.getFamily() + ";\">Benvenuto Comandante !!<br /> qual � il suo nome ?</font></center></html>");
