...
public class Button extends JLabel implements MouseListener{
	...
	public Button(String text, int width, int x, int y) {
		...
		double fattoreMolt1 = this.width / 10; //vede quanti 10 ci sono nel width (10 � la tolleranza, infatti valori che oscillano in un raggio di dimensione 10 hanno lo stesso font)
