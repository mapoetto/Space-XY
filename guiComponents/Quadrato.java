...
public class Quadrato extends JLabel implements Serializable, MouseListener{
	...
	private boolean clickato = false; //indica se � stato clickato
	private boolean scritto = false; //indica se il quadrato � associato ad una nave
	...
	public void updateView(boolean myTurn) {
		...
		if(myTurn) { 
			//se � il mio turno nascondo tutti i border dei quadrati e anche le mie navi, e mostro solo l'immagine (colpita o mancata)
